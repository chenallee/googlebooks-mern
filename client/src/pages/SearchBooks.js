...
function SearchBooks() {
    ...
    //get saved books ftom app.js on load
    ...
    const handleSaveBook = (bookId) => {
        ...
        //save the books data to our api
        saveBook(bookToSave)
            .then(() => getSavedBooks())
            .catch((err) => console.log(err));
    }
                        ...
                        return (
                            <Card key={book.bookId} border='dark'>
                                ...
                                <Card.Body>
                                    ...
                                    <Button
                                        disabled={savedBooks.some((savedBook) => savedBook.bookId === book.bookId)} className='btn-block btn-info'
